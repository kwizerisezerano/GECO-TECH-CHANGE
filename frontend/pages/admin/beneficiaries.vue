  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="lg:ml-64 min-h-screen">
      ...
      <div class="p-6">
        ...
        <!-- Beneficiaries List -->
        <div v-else-if="beneficiaries && beneficiaries.length > 0" class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div v-else class="bg-white rounded-xl shadow-md p-12 text-center">
          ...
          <p class="text-gray-600">Get started by adding your first beneficiary.</p>
        </div>
      </div>
    </div>
  </div>
