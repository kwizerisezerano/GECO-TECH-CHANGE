  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="lg:ml-64 min-h-screen">
      ...
      <div class="p-6">
        ...
        <!-- Partners List -->
        <div v-else-if="partners && partners.length > 0" class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="partner in partners" :key="partner.id" class="hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {{ partner.organization_name || partner.name || 'N/A' }}
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
        ...
        <div v-else class="bg-white rounded-xl shadow-md p-12 text-center">
          ...
          <p class="text-gray-600">Get started by adding your first partner organization.</p>
        </div>
      </div>
    </div>
  </div>
