...
<body class="index-page">
    ...
    <div class="container">
        <div class="upload-container">
            <h3 class="text-center">Add Partners</h3>
            <form action="process_upload_patrners.php" method="post" enctype="multipart/form-data">
                <!-- Project Name Input -->
                <label for="project_name" class="form-label">Partner Name:</label>
                <input type="text" name="project_name" class="form-control mb-3" required placeholder="Enter partner name">

               

                <!-- Submit Button -->
                <button type="submit" name="upload" class="btn btn-upload w-100">Add Partners</button>
            </form>
        </div>
    </div>
